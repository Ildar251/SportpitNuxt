			...
			<div class="container product">
				...
				<div class="product__info">
					<div class="container breadcrumbs">
						<NuxtLink to="/" class="breadcrumbs__item"
							>Главная страница</NuxtLink
						>
						<NuxtLink to="/catalog" class="breadcrumbs__item"
							>Продукты</NuxtLink
						>
					...
					<div class="product__info-main">
						<div class="product__info-left">
							...
							<div class="product__text-block" v-if="product.product_text">
								<div
									...
									v-html="product.product_text"
								></div>
								<button
									v-if="isTextLong"
									class="btn btn-more-down"
									:class="{ 'more--open': isTextExpanded }"
									@click="toggleText"
								>
									<span>{{
						...
						<div class="product__info-right">
							<div
								:class="
									'product__info-favorite favorite' +
						...
						>
							...
							>
								<div class="taste__image">
									<NuxtImg
										:src="config.public.apiUrl + taste.image"
										:alt="taste.taste"
										height="120"
										width="auto"
										format="webp"
						...
						<div class="dop-info" v-if="!authStore.apiToken">
							...
							<div class="product__price-info">
								...
								<div class="warning">
									...
									<div>
										<span
											>Чтобы узнать оптовую стоимость, зарегистрируйтесь на
											сайте</span
										>
