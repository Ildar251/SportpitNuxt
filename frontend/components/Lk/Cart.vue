...
watch(
    ...
    (newValues) => {
        newValues.forEach(({ id, quantity }) => {
            gsap.to(animatedQuantity.value, { [id]: quantity, duration: 0.7, ease: 'power2.out' })
        })
    },
    { deep: true }
)
...
watch(
    ...
    (newPrice) => {
        gsap.to(animatedTotalPrice, { value: newPrice, duration: 0.9, ease: 'power2.out' })
    }
)
</script>
    ...
    <div>
                ...
                <div class="cart-item__info">
                    ...
                    <div class="right">
                        ...
                        <div class="cart-item__price">
                            {{ product.price ? `${Math.round(animatedQuantity[product.id] * product.price)}` : `Цена не
                            указана` }}
                        </div>
                    </div>
                </div>
        ...
        <div class="cart-footer">
            ...
            <div class="cart-total">
                ...
                <NuxtLink to="/checkout" :class="'btn btn-submit ' + (cartStore.items.length === 0 ? 'disabled' : '')">
